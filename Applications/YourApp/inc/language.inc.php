...
$l = array(
    ...
    'book_outtime' => '您在短时间内留言过多，请稍后再留言',
    'search_is_on' => '搜索功能没有开启',
    'search_time_error' => '请稍后在搜索',
    'search_is_keywords' => '搜索关键词不能为空', //搜索关键词提示
    'search_is_param' => '缺少必要的参数：classid或者mid', //搜索提示
    'search_is_classid' => '栏目不存在', //搜索提示
    'search_is_mid' => '模型不存在', //搜索提示
);
?>