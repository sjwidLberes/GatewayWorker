...
class IndexAction extends AdminAction{
    ...
    public function update(){
        ...
        $this->smarty->display('Exam/updatecontent.html');
    }
	//复制
    public function copyInfo(){
        ...
        $this->smarty->assign('update',true);
        $this->smarty->assign('formdir',ROOT_PATH.'data/form/'.$mid.'.php');
        $this->smarty->display('Exam/copycontent.html');
    }
    //获取内容列表视图数据并注入变量
    ...
    public function index(){
        ...
        $this->smarty->display('Exam/content.html');
    }
    ...
    public function add(){
        ...
        if(isset($_POST['addInfo'])){
            ...
            rewrite::succ('增加信息成功','?m=Exam&a=index&classid='.$this->classid);
        }
        $mid = $GLOBALS['allclass'][$this->classid]['mid'];
        foreach($this->fieldArr as $v){
            if($v['ftype'] == 'editor'){
        ...
        $this->smarty->assign('classid',$this->classid);
        $this->smarty->assign('formdir',ROOT_PATH.'data/form/'.$mid.'.php');
        $this->smarty->display('Exam/addcontent.html');
    }
    //信息初始化、验证并返回
